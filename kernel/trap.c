...
usertrap(void)
{
  ...
  // need to figure out how to make the application resume where it left off after the handler returns
  // that info is saved in the trap frame
  if(which_dev == 2) {
